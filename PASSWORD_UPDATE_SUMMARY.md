...
- ✅ Set `MEMBER_PASSWORD=***REMOVED***`
- ✅ Set `ADMIN_PASSWORD=***REMOVED***`
- ✅ Set `AUTH_SECRET=***REMOVED***`
...
- ✅ Tests member login with `***REMOVED***`
- ✅ Tests admin login with `***REMOVED***`
...
|------|----------|---------------------|------------------|
| **Member** | `***REMOVED***` | `MEMBER_PASSWORD` | `/archive`, `/bulletin`, `/calendar`, `/care`, `/chat`, `/community`, `/education`, `/events`, `/organizing`, `/shop`, `/zines` |
| **Admin** | `***REMOVED***` | `ADMIN_PASSWORD` | `/admin` |
...
4. **Member Login**: Enter `***REMOVED***`
5. **Admin Login**: Go to `/admin-login` and enter `***REMOVED***`
...
3. Check password spelling (case-sensitive):
   - Member: `***REMOVED***` (note the capital G, 2, 0, 3, 0, !)
   - Admin: `***REMOVED***` (note the capital Y, 2, K, !, W, 3, r)
...
|----------|--------|----------|-------|
| `***REMOVED***` | 12 chars | Strong | Mixed case, numbers, special char |
| `***REMOVED***` | 7 chars | Medium | Mixed case, numbers, special char |
...
2. ✅ Test member login with `***REMOVED***`
3. ✅ Test admin login with `***REMOVED***`
4. ✅ Test protected routes
...
| Date | Change | Author |
|------|--------|--------|
| 2024-XX-XX | Updated passwords to `***REMOVED***` (member) and `***REMOVED***` (admin) | System |
