...
- `MEMBER_PASSWORD` for the shared community-member password. **Current password: `GurlGang2030!`**
...
- `ADMIN_PASSWORD` for administrator access. **Current password: `Y2K!W3r`**
